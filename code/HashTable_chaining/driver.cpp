...
int main (int argc, char* argv[]){
    ...
    float insert[400] = {};  // array for time cost averages in seconds of insert
    float search[400] = {}; // array for time coast in averages in seonds of search
    ...
    ofstream outFile("insert_search_performance_hash_chaining_" + DATAFILE + ".csv");
    outFile << "Iteration,Avg insertion times,Avg search times,insertion_collisions,search_collisions\n";
    for (int i = 0; i < 400; ++i){
